...
class UI_Interface:
    ...
    from ._view_edit_orders import view_listed_orders_UI, display_order_UI, owner_edit_view_individual_order_UI, return_or_arrange_collection, mark_as_received, mark_as_returned_to_owner, mark_as_returned_to_depot, delete_order
