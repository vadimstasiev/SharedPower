# source: https://github.com/kserhii/money-parser
# price_dec was modified
...
def price_dec(raw_price, round_down_to='.01', default=_not_defined):
    ...
    try:
        ...
        return decimal.Decimal(price).quantize(decimal.Decimal('.01'), rounding=decimal.ROUND_DOWN)
